...
INSERT INTO uf (id, sigla, description) VALUES
    (11,'RO','Rondônia'),
    (12,'AC','Acre'),
    (13,'AM','Amazonas'),
    (14,'RR','Roraima'),
...
ALTER TABLE city ADD CONSTRAINT fk_uf_city FOREIGN KEY (iduf) REFERENCES uf ON DELETE RESTRICT ON UPDATE CASCADE;
...
--INSERT INTO system.city VALUES                (1, 1100015, 11, 'Alta Floresta D''oeste'),
INSERT INTO city (id, iduf, description) VALUES 
